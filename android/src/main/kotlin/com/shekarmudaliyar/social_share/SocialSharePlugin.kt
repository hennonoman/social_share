...
class SocialSharePlugin(private val registrar: Registrar) : MethodCallHandler {
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        if (call.method == "shareInstagramStory") {
            ...
            val stickerImageFile = FileProvider.getUriForFile(registrar.activeContext(), registrar.activeContext().applicationContext.packageName + ".fileprovider", file)
            ...
            if (backgroundImage != null) {
                ...
                val backgroundImageFile = FileProvider.getUriForFile(registrar.activeContext(), registrar.activeContext().applicationContext.packageName + ".fileprovider", backfile)
            ...
            if (image != null) {
                ...
                val imageFileUri = FileProvider.getUriForFile(registrar.activeContext(), registrar.activeContext().applicationContext.packageName + ".fileprovider", imagefile)
                intent.type = "image/*"
